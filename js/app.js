...
var getQuakes = function(userLoc, dist) {
    $.ajax({
        ...
        success: function(fetchedQuakes) {
            ...
            quake.init();
            quake.localQuakesArr = fetchedQuakes.features;
